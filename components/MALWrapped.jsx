                ...
                >
                  {allDemographics.map((demo, idx) => {
                    ...
                    if (isTop) {
                      ...
                      finalX = (otherPosition - (others.length - 1) / 2) * 120; // Spacing for row
                      finalY = 120; // Below top one
                    }
                        ...
                        {useFlexLayout && (
                          <>
                            <motion.p 
                              ...
                              animate={{ opacity: 1, y: 0 }}
                              transition={{ delay: 1.5 + (isTop ? 0 : idx * 0.1), duration: 0.5 }}
                            >
                              {demo.name}
                            </motion.p>
                            <motion.p 
                              ...
                              transition={{ delay: 1.52 + (isTop ? 0 : idx * 0.1), duration: 0.5 }}
                            >
                              {demo.percentage}%
                            </motion.p>
                          </>
